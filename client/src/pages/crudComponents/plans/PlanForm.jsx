    ...
    <div>
      <div className="border border-base-content/15 rounded-xl lg:p-6 p-4">
        <h1 className="flex items-center gap-2 lg:text-xl text-lg font-extrabold">
          {planToUpdate && can("plan.update") ? (
            <LucideIcon.Edit />
          ) : !planToUpdate && isSuperAdmin ? (
        ...
        <form onSubmit={onPlanSubmit} className="space-y-2">
          ...
          <select
            ...
            className={`select w-full transition-all duration-150 border mt-4 ${
              errors?.packageType
          ...
          <div className="flex items-center gap-2 mt-4">
            {can("plan.create") && (
              ...
              >
                {planMutation.isPending ? (
                  ...
                  <LucideIcon.Edit size={16} />
                ) : (
                  <LucideIcon.UploadCloudIcon size={16} />
                )}
                {planMutation.isPending
                  ? "Updating..."
                  : planToUpdate
            ...
            {planToUpdate && (
              <Button
                ...
                onClick={onCancel}
              >
                <LucideIcon.RotateCcw size={16} /> Cancel
              </Button>
            )}
          </div>
        </form>
