...
const UploadCard = ({ upload, onView, onConfirmDelete }) => {
  return (
    <div className="lg:col-span-4 col-span-12">
      <figure className="relative">
        <img
          ...
          className="h-56 object-cover bg-conic-0 w-full rounded-xl transition duration-300 hover:scale-105"
        />
      ...
      <div className="mt-2 flex items-center gap-2">
        ...
        {/* <Button size="xs" variant="primary" icon={LucideIcon.EyeIcon}>
          View
        </Button> */}
        <Button
