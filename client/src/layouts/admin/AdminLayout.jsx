...
const AdminLayout = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <aside
        className={`fixed lg:static min-h-screen top-0 left-0 lg:z-10 z-50 h-full w-64 ${isSideBarOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0  bg-gray-800 text-gray-400`}
      >
